...
<div class="container-fluid">
    <h2 class="fw-bold mb-1">Welcome, <?= esc(session('name')) ?> <span class="badge bg-warning text-dark ms-2" style="font-size:0.6em">Manager</span></h2>
    <p class="text-muted mb-4">Monitor sales and manage returns.</p>
            ...
            <a href="<?= site_url('returns') ?>" class="text-decoration-none">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div><div class="text-muted small">Returns</div><div class="fw-bold fs-5">Pending Approval</div></div>
                    </div>
                </div>
            </a>
        </div>
